...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
    ...
    <div>
        ...
        <p class="page-subtitle mb-0">
            Perbarui informasi perangkat infokus yang sudah terdaftar.
        </p>
...
<select name="status"
    ...
    <option value="tersedia"
        {{ old('status', $infokus->status) == 'tersedia' ? 'selected' : '' }}>
    ...
    <option value="dipinjam"
        {{ old('status', $infokus->status) == 'dipinjam' ? 'selected' : '' }}>
...
<div class="preview-box mt-4">
    ...
    <div>
        ...
        <p class="mb-0">
            Pastikan kode infokus unik dan status perangkat sesuai dengan kondisi peminjaman terbaru.
        </p>
